...
class InternalPropertySubscription extends InternalSubscription {
    constructor(thing, name, client, form) {
        ...
        this.form = form;
        this.active = false;
        const index = this.thing.properties?.[name].forms.indexOf(form);
...
class InternalEventSubscription extends InternalSubscription {
    constructor(thing, name, client, form) {
        super(thing, name, client);
        this.form = form;
        const index = this.thing.events?.[name].forms.indexOf(form);
        if (index === undefined || index < 0) {
...
class ConsumedThing extends thing_description_1.Thing {
    ...
    async observeProperty(name, listener, errorListener, options) {
    ...
    async subscribeEvent(name, listener, errorListener, options) {
