  ...
  WoT.produce({
    ...
    properties: {
      ...
      array: {
        title: "Array",
        description:
          "An Array (List) with no structure that can be read and written",
        type: "array",
        items: {},
      },
      object: {
    ...
    events: {
      "on-bool": {
        ...
        description:
          "Event with boolean data that is emitted when the bool property is written to",
        data: { type: "boolean" },
      },
      "on-int": {
        title: "Int Property Change",
        description:
          "Event with integer data that is emitted when the int property is written to ",
        data: { type: "integer" },
      },
      "on-num": {
        title: "Num Property Change",
        description:
          "Event with number data that is emitted when the num property is written to",
        data: { type: "number" },
      },
      "on-string": {
        title: "String Property Change",
        description:
          "Event with number data that is emitted when the string property is written to",
        data: { type: "number" },
      },
      "on-array": {
        title: "Array Property Change",
        description:
          "Event with number data that is emitted when the array property is written to",
        data: { type: "number" },
      },
      "on-object": {
        title: "Object Property Change",
        description:
          "Event with number data that is emitted when the object property is written to",
        data: { type: "number" },
      },
    },
  })
